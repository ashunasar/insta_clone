...
class ProfileScreenController extends GetxController
  ...
  void setHeight(TabText e) {
    if (e.type == TabType.photos) {
      profileContentheight = 400.h + 11.h;
  ...
  List<String> profileImages = [
    'https://images-serve.onrender.com/image/v1.jpeg',
    'https://images-serve.onrender.com/image/v2.jpeg',
    'https://images-serve.onrender.com/image/v3.jpeg',
    'https://images-serve.onrender.com/image/v4.jpeg',
    'https://images-serve.onrender.com/image/v5.jpeg',
    'https://images-serve.onrender.com/image/v6.jpeg',
    'https://images-serve.onrender.com/image/v7.jpeg',
    'https://images-serve.onrender.com/image/v8.jpeg',
    'https://images-serve.onrender.com/image/v9.jpeg',
  ];
  ...
  List<Reel> reals = [
    Reel(
        id: '1',
        viewsCount: '256K',
        contentUrl: 'https://images-serve.onrender.com/image/v1.jpeg'),
    Reel(
        id: '1',
        viewsCount: '220K',
        contentUrl: 'https://images-serve.onrender.com/image/v2.jpeg'),
    Reel(
        id: '1',
        viewsCount: '358K',
        contentUrl: 'https://images-serve.onrender.com/image/v3.jpeg'),
    Reel(
        id: '1',
        viewsCount: '240K',
        contentUrl: 'https://images-serve.onrender.com/image/v4.jpeg'),
    Reel(
        id: '1',
        viewsCount: '256K',
        contentUrl: 'https://images-serve.onrender.com/image/v5.jpeg'),
    Reel(
        id: '1',
        viewsCount: '220K',
        contentUrl: 'https://images-serve.onrender.com/image/v6.jpeg'),
    Reel(
        id: '1',
        viewsCount: '358K',
        contentUrl: 'https://images-serve.onrender.com/image/v7.jpeg'),
    Reel(
        id: '1',
        viewsCount: '240K',
        contentUrl: 'https://images-serve.onrender.com/image/v8.jpeg'),
  ];
